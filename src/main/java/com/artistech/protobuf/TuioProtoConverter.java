...
//                                    System.out.println("Prop1 Name!: " + targetProp.getName());
    ...
    public ArrayList<ImmutablePair<String, String>> supportedConversions() {
        ...
        ret.add(new ImmutablePair<String, String>(com.artistech.protobuf.TuioProtos.Object.class.getName(), TUIO.TuioObject.class.getName()));
        ret.add(new ImmutablePair<String, String>(com.artistech.protobuf.TuioProtos.Cursor.class.getName(), TUIO.TuioCursor.class.getName()));
        ret.add(new ImmutablePair<String, String>(com.artistech.protobuf.TuioProtos.Blob.class.getName(), TUIO.TuioBlob.class.getName()));
        ret.add(new ImmutablePair<String, String>(com.artistech.protobuf.TuioProtos.Time.class.getName(), TUIO.TuioTime.class.getName()));
        return ret;
    }
